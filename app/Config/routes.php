 ...
 */
	...
	Router::connect('/admin',array('prefix' => 'admin','controller' => 'posts', 'action' => 'index', 'admin' => true));

	Router::connect('/admin/:controller/:action/*', array('admin' => true, 'prefix' => 'admin', 'controller' => 'posts'));
